...
<html
    ...
    <head>
        ...
        <script src="../assets_vuexy/jquery/jquery.min.js"></script>
        ...
        <style>
            ...
            /* Estilo de la etiqueta span de error - VALIDACIÓN */
            span.error{ 
                color: red; 
                font-size: 13px !important;
            }
        ...
        <style>
            ...
            ::-webkit-scrollbar-thumb {
                background: linear-gradient(90deg, #a9a9a9,#c1c1c1);
                border-radius: 10px;
            ...
            ::-webkit-scrollbar-thumb:hover {
                background: linear-gradient(90deg, #8c8c8c, #c1c1c1);
            }
